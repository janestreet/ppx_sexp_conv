...
module Sexp_of_t_portable : sig @@ portable
...
module Sexp_of_not_t_portable : sig @@ portable
  include module type of struct
...
module Of_sexp_t_portable : sig @@ portable
  include module type of struct
    include Of_sexp_t
  end
end = struct
...
module Of_sexp_not_t_portable : sig @@ portable
  include module type of struct
...
module Sexp_t_portable : sig @@ portable
  include module type of struct
    include Sexp_t
  end
end = struct
...
module Sexp_not_t_portable : sig @@ portable
  include module type of struct
    include Sexp_not_t
  end
end = struct
...
module Sexp_t1_portable : sig @@ portable
  include module type of struct
    include Sexp_t1
  end
end = struct
