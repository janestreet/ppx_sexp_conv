       ...
       Sexplib0.Sexp_conv_record.record_of_sexp
         ...
         ~fields:
           (Field
              ...
              ; conv =
                  (fun x__405_ ->
                    let _x__406_ = (option_of_sexp int_of_sexp) x__405_ in
                    fun () -> _x__406_)
              ; rest =
                  Field
                    { name = "b"
                    ...
                    ; conv =
                        (fun x__403_ ->
                          let _x__404_ = (list_of_sexp int_of_sexp) x__403_ in
                          fun () -> _x__404_)
                    ; rest =
                        Field
                          { name = "c"
                          ...
                          ; conv =
                              (fun x__401_ ->
                                let _x__402_ = unit_of_sexp x__401_ in
                                fun () -> _x__402_)
                          ; rest =
                              Field
                                { name = "d"
                                ...
                                ; conv =
                                    (fun x__399_ ->
                                      let _x__400_ = int_of_sexp x__399_ in
                                      fun () -> _x__400_)
                                ; rest = Empty
                                }
                          }
       ...
       Sexplib0.Sexp_conv_record.record_of_sexp
         ...
         ~fields:
           (Field
              ...
              ; conv =
                  (fun x__437_ ->
                    let _x__438_ = int_of_sexp x__437_ in
                    fun () -> _x__438_)
              ; rest = Empty
              })
         ~index_of_field:(function
         ...
         Sexplib0.Sexp_conv_record.record_of_sexp
           ...
           ~fields:
             (Field
                ...
                ; conv =
                    (fun x__450_ ->
                      let _x__451_ = (u_of_sexp int_of_sexp) x__450_ in
                      fun () -> _x__451_)
                ; rest =
                    Field
                      { name = "b"
                      ...
                      ; conv =
                          (fun x__448_ ->
                            let _x__449_ = int_of_sexp x__448_ in
                            fun () -> _x__449_)
                      ; rest = Empty
                      }
                })
        ...
        Sexplib0.Sexp_conv_record.record_of_sexp
          ...
          ~fields:
            (Field
               ...
               ; conv =
                   (fun x__458_ ->
                     let _x__459_ = t_of_sexp x__458_ in
                     fun () -> _x__459_)
               ; rest =
                   Field
                     { name = "a"
                     ...
                     ; conv =
                         (fun x__456_ ->
                           let _x__457_ = _of_a__453_ x__456_ in
                           fun () -> _x__457_)
                     ; rest = Empty
                     }
               })
