...
module Record_with_defaults_and_stackify = struct
  ...
  let sexp_of_t =
    (let default__402_ : string = ""
     ...
     and drop_default__417_ : string -> string -> Stdlib.Bool.t = String.equal__local
     and drop_if__423_ : string -> Stdlib.Bool.t = fun s -> String.equal__local "" s in
  ...
  let sexp_of_t__stack =
    (let default__431_ : string = ""
     ...
     and drop_default__446_ : string -> string -> Stdlib.Bool.t = String.equal__local
     and drop_if__452_ : string -> Stdlib.Bool.t = fun s -> String.equal__local "" s in
     fun { a = a__428_; b = b__432_; c = c__437_; d = d__442_; e = e__448_; f = f__453_ } ->
...
module Local_inputs_and_stackify = struct
  ...
  module Record : sig
    ...
    let sexp_of_t__stack : 'a. ('a -> Sexplib0.Sexp.t) -> 'a t -> Sexplib0.Sexp.t =
      fun _of_a__651_ { a = a__653_; x = x__655_ } ->
