...
See =Base.Sexp.Grammar= for details.
...
#+BEGIN_SRC ocaml
[%sexp_grammar: 'a -> 'b -> ('a, 'b) Either.t]
#+END_SRC

We represent polymorphic types as arrow types because explicitly polymorphic
variables are not allowed as the payload of extension nodes:

#+BEGIN_SRC ocaml
[%sexp_grammar: 'a 'b . ('a, 'b) Either.t]  (* Syntax error *)
#+END_SRC

Meanwhile, the grammar of functions is uninteresting, because they cannot be
deserialized.
